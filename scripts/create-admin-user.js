...
async function createAdminUser() {
  try {
    ...
    // Admin user details
    const adminData = {
      email: 'yashdeep@yashdeeptandon.me',
      password: 'Yashdeep@007',
    ...
    if (verifyUser) {
      const isPasswordValid = await verifyUser.comparePassword(adminData.password);
      console.log('🔐 Password verification:', isPasswordValid ? '✅ Valid' : '❌ Invalid');
      console.log('👑 Role verification:', verifyUser.role === 'admin' ? '✅ Admin' : '❌ Not Admin');
      console.log('🟢 Active status:', verifyUser.isActive ? '✅ Active' : '❌ Inactive');
    }
