        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 max-w-2xl">
              I create innovative web applications and software solutions that make a difference. 
              With expertise in modern technologies and a passion for clean, efficient code, 
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <button
                ...
                className="border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white font-semibold py-3 px-8 rounded-lg transition-all duration-300"
              >
                View My Work
              </button>
            </div>
