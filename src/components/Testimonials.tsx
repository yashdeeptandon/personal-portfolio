  ...
  const testimonials = [
    {
      ...
      rating: 5,
      text: "Yashdeep is an exceptional developer who consistently delivers high-quality code. His attention to detail and ability to solve complex problems makes him an invaluable team member. He led our React migration project and improved our app performance by 40%.",
    ...
    },
    {
      ...
      rating: 5,
      text: "Working with Yashdeep was a game-changer for our startup. He built our entire platform from scratch and helped us scale to 10,000+ users. His full-stack expertise and mentoring skills are outstanding.",
    ...
    },
    {
      ...
      rating: 5,
      text: "Yashdeep has an incredible ability to translate design concepts into pixel-perfect, responsive websites. His collaboration skills and technical expertise made our projects seamless and successful.",
    ...
    },
    {
      ...
      rating: 5,
      text: "As Yashdeep's mentor early in his career, I watched him grow into an exceptional developer. His eagerness to learn, problem-solving skills, and code quality are impressive. He's now mentoring others with the same dedication.",
    ...
    },
    {
      ...
      rating: 5,
      text: "Yashdeep delivered our e-commerce website ahead of schedule and under budget. The site performs beautifully, and our sales increased by 60% after launch. His communication throughout the project was excellent.",
    ...
    },
    {
      ...
      rating: 5,
      text: "Yashdeep is an amazing mentor who helped me grow as a developer. His code reviews are thorough and educational, and he always makes time to explain complex concepts. I learned more in 6 months working with him than in my previous year.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Testimonials from colleagues, clients, and mentees who have worked
            with me
          </p>
        </div>
