...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      technologies: ['Next.js', 'MongoDB', 'Socket.io', 'TypeScript', 'Chakra UI'],
      category: 'frontend',
    ...
    },
    {
      ...
      description: 'A responsive weather dashboard that provides real-time weather data, forecasts, and interactive maps. Built with React and integrated with multiple weather APIs.',
    ...
    },
    {
      ...
      description: 'A scalable REST API service built with Express.js and PostgreSQL. Includes authentication, rate limiting, caching, and comprehensive documentation.',
    ...
    },
    {
      ...
      description: 'A comprehensive analytics dashboard for social media metrics. Features data visualization, trend analysis, and automated reporting capabilities.',
