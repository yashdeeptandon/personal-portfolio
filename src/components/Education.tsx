const Education = () => {
  ...
  const certifications = [
    ...
    },
    {
      ...
      description: 'Demonstrates understanding of Scrum framework and ability to support Scrum teams.',
    ...
    },
    {
      ...
      description: 'Proficiency in Google Analytics for web analytics and data-driven decision making.',
                    ...
                    <div className="flex flex-wrap items-start justify-between mb-4">
                      <div>
                        ...
                        <div className="flex flex-wrap gap-4 text-sm text-gray-600 dark:text-gray-300 mb-4">
                          ...
                          <span className="flex items-center">
                            <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3a2 2 0 012-2h4a2 2 0 012 2v4m-6 0h6m-6 0v1a2 2 0 002 2h2a2 2 0 002-2V7m-6 0H4a2 2 0 00-2 2v9a2 2 0 002 2h16a2 2 0 002-2V9a2 2 0 00-2-2h-2" />
                            </svg>
                            {edu.period}
                          </span>
                          {edu.gpa && (
