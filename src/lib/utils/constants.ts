...
export const TECHNOLOGIES = [
  ...
  'Svelte', 'Tailwind CSS', 'Bootstrap', 'Sass', 'Less', 'Styled Components',
  
  // Backend
  'Node.js', 'Express.js', 'Nest.js', 'Python', 'Django', 'Flask', 'FastAPI',
  'PHP', 'Laravel', 'Java', 'Spring Boot', 'C#', '.NET', 'Ruby', 'Ruby on Rails',
  'Go', 'Rust', 'Kotlin',
  ...
  'Kubernetes', 'Jenkins', 'GitHub Actions', 'GitLab CI', 'Terraform',
  
  // Mobile
  'React Native', 'Flutter', 'Swift', 'Kotlin', 'Ionic', 'Xamarin',
  
  // Tools & Others
  'Git', 'GitHub', 'GitLab', 'Figma', 'Adobe XD', 'Photoshop', 'Webpack',
...
export const SEO_DEFAULTS = {
  ...
  DEFAULT_DESCRIPTION: 'Full-stack developer specializing in modern web technologies',
  DEFAULT_KEYWORDS: ['web developer', 'full-stack', 'javascript', 'react', 'nextjs'],
  OG_TYPE: 'website',
